...
class ExternalDocRequestEndpointIntTest : IntegrationTestBase() {
    ...
    fun `should send SQS message for each case`() {
        ...
        val firstCase = CaseDetails(caseNo = 166662981, cId = 1218461, caseId = 1218461, defendantName = "MR Abraham LINCOLN", pnc = "20030011985X", cro = "CR0006100061")
        val secondCase = CaseDetails(caseNo = 1777732980, cId = 1218888, caseId = 1218888, defendantName = "Mr Theremin MELLOTRON", pnc = "20120052494Q", cro = "CR0006200062")
